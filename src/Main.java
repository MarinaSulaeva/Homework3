public class Main {
    ...
    public static void task8() {
        ...
        System.out.println("Маша теперь получает " + newSalaryForMasha + " рублей. Годовой доход вырос на " + differenceForMasha + " рублей");
        System.out.println("Денис теперь получает " + newSalaryForDenis + " рублей. Годовой доход вырос на " + differenceForDenis + " рублей");
        System.out.println("Кристина теперь получает " + newSalaryForKris+ " рублей. Годовой доход вырос на " + differenceForKris + " рублей");
    }
}